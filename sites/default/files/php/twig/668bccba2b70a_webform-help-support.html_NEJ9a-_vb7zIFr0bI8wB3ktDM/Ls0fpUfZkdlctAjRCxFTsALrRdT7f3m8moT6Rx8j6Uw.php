...
class __TwigTemplate_6884ad0a922ceb709b05ca2e26d46881 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"webform-help-support__items\">
    ...
    <div class=\"webform-help-support__item\">
      ...
      <div class=\"webform-help-support__item-details\">
        <h3 class=\"webform-help-support__item-title\">";
        // line 33
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Professional support"));
        yield "</h3>
        ";
        // line 34
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Hire the Webform module's subject matter expert (SME) to ensure the success of your project. I can review your project plan, recommend solutions, and implement custom features."));
        yield "<br/>
        ...
        <em>";
        // line 36
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Starting at \$800"));
        yield "</em>
      </div>
    </div>
  </div>
...
";
    ...
    {
        return array (  108 => 36,  104 => 35,  100 => 34,  96 => 33,  87 => 27,  83 => 26,  79 => 25,  75 => 24,  66 => 18,  62 => 17,  58 => 16,  54 => 15,  46 => 10,  40 => 7,);
    }

    public function getSourceContext()
    {
        return new Source("", "modules/contrib/webform/templates/webform-help-support.html.twig", "/app/modules/contrib/webform/templates/webform-help-support.html.twig");
    }
